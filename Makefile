...
CXXFILES=src/gcn.cu src/optim.cpp src/module.cu src/variable.cpp src/parser.cpp src/rand.cpp src/timer.cpp src/cuda_check.cu src/cuda_rand.cu src/cuda_variable.cu src/cuda_sparse.cu
